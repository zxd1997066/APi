...
class TestFuture(TestCase):
    ...
    def test_done(self) -> None:
        ...
        f.set_result(torch.ones(2, 2, device="xpu"))
    ...
    def test_done_exception(self) -> None:
        ...
        f1.set_result(torch.ones(2, 2, device="xpu"))
    ...
    def test_wait(self) -> None:
        ...
        self.assertEqual(f.wait(), torch.ones(2, 2, device="xpu"))
    ...
    def test_wait_multi_thread(self) -> None:
        ...
        t = threading.Thread(target=slow_set_future, args=(f, torch.ones(2, 2, device="xpu")))
        t.start()
    ...
    def test_then(self):
        ...
        fut.set_result(torch.ones(2, 2, device="xpu"))
        self.assertEqual(fut.wait(), torch.ones(2, 2, device="xpu"))
        self.assertEqual(then_fut.wait(), torch.ones(2, 2, device="xpu") + 1)
    ...
    def test_chained_then(self):
        ...
        for i in range(len(futs)):
            self.assertEqual(futs[i].wait(), torch.ones(2, 2, device="xpu") + i + 1)
